...
func NewNodeRepository(db *sql.DB, queries *generated.Queries) *NodeRepository {
...
func (r *NodeRepository) GetByID(ctx context.Context, id int64) (generated.Node, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) (generated.Node, error) {
		return queries.GetNodeByID(ctx, id)
	})
}

func (r *NodeRepository) GetByAgentTokenHash(ctx context.Context, hash string) (generated.Node, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) (generated.Node, error) {
		return queries.GetNodeByAgentTokenHash(ctx, sql.NullString{String: hash, Valid: hash != ""})
	})
}

func (r *NodeRepository) Create(ctx context.Context, params generated.CreateNodeParams) (generated.Node, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) (generated.Node, error) {
		return queries.CreateNode(ctx, params)
	})
}
...
func (r *NodeRepository) EnsureManagedByProject(ctx context.Context, projectID int64, name string, identifier string) (generated.Node, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) (generated.Node, error) {
		return queries.EnsureManagedNodeByProject(ctx, generated.EnsureManagedNodeByProjectParams{
			ProjectID:  projectID,
			Name:       name,
...
func (r *NodeRepository) UpdateState(ctx context.Context, nodeID int64, state string) (generated.Node, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) (generated.Node, error) {
		return queries.UpdateNodeState(ctx, generated.UpdateNodeStateParams{
			ID:           nodeID,
			CurrentState: state,
		})
	})
...
func (r *NodeRepository) UpdateAgentTokenHash(ctx context.Context, nodeID int64, hash string) (generated.Node, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) (generated.Node, error) {
		return queries.UpdateNodeAgentTokenHash(ctx, generated.UpdateNodeAgentTokenHashParams{
			ID:             nodeID,
...
func (r *NodeRepository) UpdateIdentity(ctx context.Context, nodeID int64, name string, identifier string) (generated.Node, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) (generated.Node, error) {
		return queries.UpdateNodeIdentity(ctx, generated.UpdateNodeIdentityParams{
			ID:         nodeID,
			Name:       name,
			Identifier: identifier,
		})
...
func (r *NodeRepository) Delete(ctx context.Context, nodeID int64) (int64, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) (int64, error) {
		return queries.DeleteNodeByID(ctx, nodeID)
	})
}

func (r *NodeRepository) ListStaleOnline(ctx context.Context, cutoff time.Time) ([]generated.Node, error) {
	return withRLSQueries(ctx, r.db, r.queries, func(queries *generated.Queries) ([]generated.Node, error) {
		return queries.ListStaleOnlineNodes(ctx, sql.NullTime{Time: cutoff, Valid: true})
	})
}
