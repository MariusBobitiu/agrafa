...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/instance-settings": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.InstanceSettingsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Instance settings update payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.InstanceSettingsUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/notification-recipients/test-email": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Notification recipient test email payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.NotificationRecipientTestEmailRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/services/{id}/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Number of observations (default 100, maximum 500)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "types.InstanceSettingDocument": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
                    "example": "Enables outbound email delivery when provider config is complete."
                },
                "group": {
                    "type": "string",
                    "example": "email"
        ...
        "types.InstanceSettingsResponse": {
            "type": "object",
            "properties": {
                "settings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/types.InstanceSettingDocument"
                    }
                }
            }
        },
        "types.InstanceSettingsUpdateItemRequest": {
            "type": "object",
            "properties": {
                "key": {
                    "type": "string",
        ...
        "types.InstanceSettingsUpdateRequest": {
            "type": "object",
            "properties": {
                "settings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/types.InstanceSettingsUpdateItemRequest"
                    }
                }
            }
        },
        ...
        "types.NotificationRecipientTestEmailRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
        ...
        "types.ServiceHistoryEntryDocument": {
            "type": "object",
            "properties": {
                "check_type": {
                    "type": "string",
        ...
        "types.ServiceHistoryPaginationDocument": {
            "type": "object",
            "properties": {
                "has_more": {
                    "type": "boolean",
                ...
                "next_cursor": {
                    "type": "string",
                    "example": "eyJvYnNlcnZlZF9hdCI6IjIwMjYtMDgtMjNUMTI6MDA6MDBaIiwiaWQiOjMwMX0"
                }
            }
        },
        "types.ServiceHistoryResponse": {
            "type": "object",
            "properties": {
                "history": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/types.ServiceHistoryEntryDocument"
                    }
                },
                "pagination": {
