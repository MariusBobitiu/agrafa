...
export const projectInvitationsApi = {
  ...
  ): Promise<ProjectInvitationCreateBatchResponse> => api.post("/project-invitations", payload),
  ...
  accept: (payload: ProjectInvitationAcceptInput): Promise<ProjectInvitationAcceptResponse> =>
    api.post("/project-invitations/accept", payload),

  delete: (id: string): Promise<void> => api.del(`/project-invitations/${id}`),
};
