...
export const projectsApi = {
  list: (): Promise<{ projects: ProjectSummary[] }> => api.get("/projects"),

  get: (id: number): Promise<{ project: ProjectDetail }> => api.get(`/projects/${id}`),
  ...
  delete: (id: number): Promise<void> => api.del(`/projects/${id}`),
};
